<template>
  <div class="user-info-plane-dialog inline-block">
    ...
    <el-dialog class="page-dialog-wrapper" v-if="dialogleVisible" title="" width="400px" :visible.sync="dialogleVisible" append-to-body @close="closePop">
